            ...
            <div class="table-responsive">
                <table class="table datatable table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        WHERE rm = '$detail' and a.id_ruang='1' ORDER BY id_rm DESC");
                        $i = 1;
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapushasil<?= $id_rm; ?>"><i class=" bi bi-trash-fill"></i></button>
                                        <a type="button" class="btn btn-primary btn-sm" href="detail-hp.php?id_rm=<?php echo $data["id_rm"]; ?>"><i class=" bi bi-eye-fill"></i></a>
                                        <a type="button" class="btn btn-success btn-sm" href="../../cetak/cetak-hp.php?id_rm=<?php echo $data["id_rm"]; ?>"><i class=" bi bi-printer-fill"></i></a>
