...
<body>
  ...
  <main id="main" class="main">
    ...
    <?php
    $tampildokter = mysqli_query($conn, "SELECT * FROM dokter a left join ruang b on a.id_ruang=b.id_ruang WHERE nip_dokter='$detail'");
          ...
          <div class="col-xl-4">
            ...
            <div class="card">
              <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <img src="img/<?= $foto_dokter; ?>" alt="<?= $foto_dokter; ?>" class="rounded-circle">
                <h2><?= $nama_dokter; ?></h2>
                ...
                <div class="tab-content pt-2">
                  ...
                  <div class="tab-pane fade show active profile-overview" id="profile-overview">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-9 col-md-8"><?php echo $data['password_dokter']; ?></div>
                    </div>
