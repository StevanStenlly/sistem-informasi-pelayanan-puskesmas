...
<body>
  ...
  <main id="main" class="main">
    ...
    <?php
    $tampilpetugas = mysqli_query($conn, "SELECT * FROM petugas a left join ruang b on a.id_ruang=b.id_ruang WHERE nip_petugas = '$detail'");
    ...
    ?>
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="../Dashboard/index.php">Beranda</a></li>
          ...
          <div class="col-xl-4">
            ...
            <div class="card">
              <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <img src="img/<?php echo $data['foto_petugas']; ?>" alt="<?php echo $data['foto_petugas']; ?>" class="rounded-circle">
                ...
                <div class="tab-content pt-2">
                  ...
                  <div class="tab-pane fade show active profile-overview" id="profile-overview">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-9 col-md-8"><?php echo $data['password_petugas']; ?></div>
                    </div>
