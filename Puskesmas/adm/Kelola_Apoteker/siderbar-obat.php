...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#dokter-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-layout-text-window-reverse"></i><span>Kelola Dokter</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="dokter-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
        ...
        <li>
          <a href="../Kelola_Rekam_Medis/tabel-rm.php">
    ...
    <li class="nav-item">
      <a class="nav-link " data-bs-target="#petugas-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-layout-text-window-reverse"></i><span>Kelola Petugas</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="petugas-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        <li>
        ...
        <li>
          <a href="../Kelola_Apoteker/tabel-obat.php" class="active">
