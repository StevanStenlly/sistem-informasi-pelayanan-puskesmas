...
// Proses form simpan hasil pemeriksaan (pindah ke sini agar dijalankan setelah form dikirim)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['updatehasil'])) {
    include 'function-hp.php';
    exit();
}
                        ...
                        <div class="card">
                            <div class="card-body pt-3">
                                ...
                                <ul class="nav nav-tabs nav-tabs-bordered">
                                    ...
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Tambah Data Hasil Pemeriksaan</button>
                                    </li>

                                    <li class="nav-item">
                                        <a type="button" class="btn btn-success btn-sm" href="tabel-rm.php?nik_pasien=<?php echo $data["nik_pasien"]; ?>&id_rm=<?= $id_rm ?>">Rekam Medis</a>
                                    </li>
