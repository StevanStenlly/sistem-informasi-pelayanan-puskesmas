                ...
                <table class="table table-hover table-bordered table-striped hidden-until-ready" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    while ($data = mysqli_fetch_array($ambilsemuahasil)) {
                      ...
                      $tgl_pemeriksaan = date('d-m-Y', strtotime($data['tgl_pemeriksaan']));
                      $ICD_10 = $data['ICD_10'] ?? '';
                      ...
                      while ($resep = mysqli_fetch_assoc($resultResep)) {
                        $resep_obat .= htmlspecialchars($resep['nama_obat']) . " (" . htmlspecialchars($resep['dosis']) . ", " . htmlspecialchars($resep['jumlah']) . ")<br>";
                      }
                      if (empty($resep_obat)) {
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="text-center"><?= $tgl_pemeriksaan; ?></td>
