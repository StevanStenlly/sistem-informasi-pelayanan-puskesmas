...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../Riwayat_screening/riwayat_screening.php">Riwayat Screening</a></li>
        ...
        <?php
        $tampilrm = mysqli_query($conn, "SELECT * FROM rekam_medis a left join pasien b on a.nik_pasien=b.nik_pasien 
        left join ruang c on a.id_ruang=c.id_ruang left join petugas d on a.nip_petugas=d.nip_petugas WHERE id_rm = '$detail' ");
        while ($data = mysqli_fetch_array($tampilrm)) {
            $id_rm = $data['id_rm'];
