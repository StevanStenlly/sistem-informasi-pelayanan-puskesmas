...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <nav class="header-nav ms-auto">
    <?php
    $nip_pet = $_SESSION['apoteker_nip']; // Ganti ke prefix khusus apoteker

    $tampilpetugas = mysqli_query($conn, "SELECT * FROM petugas WHERE nip_petugas='$nip_pet'");
    if ($data = mysqli_fetch_array($tampilpetugas)) :
    ?>
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $data['nama_petugas']; ?></span>
          </a>

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo $data['nama_petugas']; ?></h6>
              <span>Petugas Apotek</span>
            </li>
            <li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="../Profil_Petugas/users-profile.php">
