				...
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						...
						<div class="login-wrap p-4 p-md-5">
							<div class="d-flex">
								<div class="w-100">
									<h3 class="mb-4">LOGIN APOTEKER</h3>
								</div>
							</div>
							<form action="proses-loginpetugas.php" method="POST" class="signin-form" autocomplete="off">
								<div class="form-group mb-3">
									...
									<input type="text" name="nip_petugas" class="form-control" placeholder="NIP" maxlength="18" inputmode="numeric" pattern="\d*" oninput="this.value=this.value.replace(/[^0-9]/g,'')" required>
								</div>
								<div class="form-group mb-3">
